...
RUN yum -y install wget && wget https://github.com/graalvm/graalvm-ce-dev-builds/releases/download/22.3.0-dev-20220902_0358/graalvm-ce-java11-linux-amd64-dev.tar.gz && tar xvf graalvm-ce-java11-linux-amd64-dev.tar.gz && mv graalvm-ce-java11-linux-amd64-dev /usr/java
