...
public class Nd4jOptimizer implements Callable<Integer> {
    ...
    public Integer call() throws Exception {
        ...
        invocationRequest.setGoals(Arrays.asList((extension != null ? " -Djavacpp.platform.extension=" + extension : "") + " -Dlibnd4j.buildThreads=" + buildThreads +  (extension != null ? " -Dlibnd4j.extension=" + extension: "") + " -Djavacpp.platform=" + javacppPlatform," -DskipTests -Dlibnd4j.operations=\"" + operations + "\" -Dlibnd4j.datatypes=\"" + dataTypes + "\" -Dlibnd4j.helper=" + helper ,clean ? "clean" : "","package"));
        ...
        nd4jPresetBuild.setGoals(Arrays.asList("-Djavacpp.platform=" + javacppPlatform," -Dmaven.test.skip=true -Dlibnd4j.operations=\"" + operations + "\" -Dlibnd4j.datatypes=\"" + dataTypes + "\" -Dlibnd4j.helper=" + helper + (mavenDebug ? " -X " : "") ,clean ? "clean" : "","install"));
        ...
        nd4jBackendBuild.setGoals(Arrays.asList("-Djavacpp.platform=" + javacppPlatform," -Dmaven.test.skip=true -Dlibnd4j.operations=\"" + operations + "\" -Dlibnd4j.datatypes=\"" + dataTypes + "\" -Dlibnd4j.helper=" + helper + (mavenDebug ? " -X " : "") ,clean ? "clean" : "","install"));
